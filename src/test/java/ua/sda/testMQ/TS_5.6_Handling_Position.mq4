...
//               Print ("Блок ведения, ", "firstMinGlobal = ", firstMinGlobal, " secondMinGlobal = ", secondMinGlobal);
              ...
              Print("firstMinGlobal = ",  firstMinGlobal, "secondMinGlobal = ",secondMinGlobal, "stopLossForBuyMin = ",stopLossForBuyMin);
...
//               Print ("Блок ведения, ", "firstMaxGlobal = ", firstMaxGlobal, " secondMaxGlobal = ", secondMaxGlobal);
               ...
               Print("firstMaxGlobal = ",  secondMaxGlobal, "secondMinGlobal = ",secondMinGlobal, "stopLossForSellMax = ",stopLossForSellMax);
         ...
         for(j; j<i+2; j++)
           {
            ...
            priceForMinMax=iOpen(NULL,period,j);
            Print("firstMinLocalSymmetric = ", firstMinLocalSymmetric);
         ...
         for(m; m<i+2; m++)
           {
            ...
            priceForMinMax=iOpen(NULL,period,m);
            Print("secondMinLocalSymmetric = ", secondMinLocalSymmetric);
